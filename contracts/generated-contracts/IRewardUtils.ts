...
export interface IRewardUtilsInterface extends ethers.utils.Interface {
  functions: {
...
export interface IRewardUtils extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IRewardUtilsInterface;
