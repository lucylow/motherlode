...
export interface IDelegationUtilsInterface extends ethers.utils.Interface {
  functions: {
...
export interface IDelegationUtils extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IDelegationUtilsInterface;
