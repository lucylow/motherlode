...
export interface IGetterUtilsInterface extends ethers.utils.Interface {
  functions: {
...
export interface IGetterUtils extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IGetterUtilsInterface;
