...
export interface ITransferUtilsInterface extends ethers.utils.Interface {
  functions: {
...
export interface ITransferUtils extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ITransferUtilsInterface;
