...
export interface IApi3TokenInterface extends ethers.utils.Interface {
  functions: {
...
export type BurnerStatusUpdatedEvent = TypedEvent<
  [string, boolean],
  { burnerAddress: string; burnerStatus: boolean }
>;

export type BurnerStatusUpdatedEventFilter = TypedEventFilter<BurnerStatusUpdatedEvent>;

export type MinterStatusUpdatedEvent = TypedEvent<
  [string, boolean],
  { minterAddress: string; minterStatus: boolean }
>;

export type MinterStatusUpdatedEventFilter = TypedEventFilter<MinterStatusUpdatedEvent>;
...
export interface IApi3Token extends BaseContract {
  ...
  filters: {
    ...
    "BurnerStatusUpdated(address,bool)"(
      burnerAddress?: string | null,
      burnerStatus?: null
    ): BurnerStatusUpdatedEventFilter;
    BurnerStatusUpdated(
      burnerAddress?: string | null,
      burnerStatus?: null
    ): BurnerStatusUpdatedEventFilter;
    ...
    "MinterStatusUpdated(address,bool)"(
      ...
      minterStatus?: null
    ): MinterStatusUpdatedEventFilter;
    MinterStatusUpdated(
      minterAddress?: string | null,
      minterStatus?: null
    ): MinterStatusUpdatedEventFilter;
