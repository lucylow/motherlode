...
export interface ITimelockUtilsInterface extends ethers.utils.Interface {
  functions: {
...
export interface ITimelockUtils extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ITimelockUtilsInterface;
