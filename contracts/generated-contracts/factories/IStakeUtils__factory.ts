...
import type { IStakeUtils, IStakeUtilsInterface } from "../IStakeUtils";
...
export class IStakeUtils__factory {
  static readonly abi = _abi;
  static createInterface(): IStakeUtilsInterface {
    return new utils.Interface(_abi) as IStakeUtilsInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IStakeUtils {
    return new Contract(address, _abi, signerOrProvider) as IStakeUtils;
  }
}
