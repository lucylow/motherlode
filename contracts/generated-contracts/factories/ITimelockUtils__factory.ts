...
export class ITimelockUtils__factory {
  static readonly abi = _abi;
  static createInterface(): ITimelockUtilsInterface {
    return new utils.Interface(_abi) as ITimelockUtilsInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ITimelockUtils {
    return new Contract(address, _abi, signerOrProvider) as ITimelockUtils;
  }
}
