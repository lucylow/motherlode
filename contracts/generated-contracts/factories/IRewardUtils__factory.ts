...
import type { IRewardUtils, IRewardUtilsInterface } from "../IRewardUtils";
...
export class IRewardUtils__factory {
  static readonly abi = _abi;
  static createInterface(): IRewardUtilsInterface {
    return new utils.Interface(_abi) as IRewardUtilsInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IRewardUtils {
    return new Contract(address, _abi, signerOrProvider) as IRewardUtils;
  }
}
