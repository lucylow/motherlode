...
export class DelegationUtils__factory {
  static readonly abi = _abi;
  static createInterface(): DelegationUtilsInterface {
    return new utils.Interface(_abi) as DelegationUtilsInterface;
  }
  static connect(
    address: string,
