...
import type { IClaimUtils, IClaimUtilsInterface } from "../IClaimUtils";
...
export class IClaimUtils__factory {
  static readonly abi = _abi;
  static createInterface(): IClaimUtilsInterface {
    return new utils.Interface(_abi) as IClaimUtilsInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IClaimUtils {
    return new Contract(address, _abi, signerOrProvider) as IClaimUtils;
  }
}
