...
import type { IGetterUtils, IGetterUtilsInterface } from "../IGetterUtils";
...
export class IGetterUtils__factory {
  static readonly abi = _abi;
  static createInterface(): IGetterUtilsInterface {
    return new utils.Interface(_abi) as IGetterUtilsInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IGetterUtils {
    return new Contract(address, _abi, signerOrProvider) as IGetterUtils;
  }
}
