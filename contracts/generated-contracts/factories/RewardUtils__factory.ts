...
import type { RewardUtils, RewardUtilsInterface } from "../RewardUtils";
...
export class RewardUtils__factory {
  static readonly abi = _abi;
  static createInterface(): RewardUtilsInterface {
    return new utils.Interface(_abi) as RewardUtilsInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): RewardUtils {
    return new Contract(address, _abi, signerOrProvider) as RewardUtils;
  }
}
