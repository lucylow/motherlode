...
import type {
  ITimelockManager,
  ITimelockManagerInterface,
} from "../ITimelockManager";
...
export class ITimelockManager__factory {
  ...
  static createInterface(): ITimelockManagerInterface {
    return new utils.Interface(_abi) as ITimelockManagerInterface;
  }
  static connect(
    address: string,
